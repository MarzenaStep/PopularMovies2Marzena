...
public class FavouritesAdapter extends RecyclerView.Adapter<FavouritesAdapter.FavouritesMoviesViewHolder> {
    ...
    @NonNull
    @Override
    public FavouritesMoviesViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavouritesMoviesViewHolder favouritesMoviesViewHolder, int position) {
        ...
        String favouritesMoviePosterUrl = mCursor.getString(posterUrlColumnIndex);
