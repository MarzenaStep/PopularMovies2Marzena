...
public class DetailActivity extends AppCompatActivity implements TrailerAdapter.TrailerAdapterOnClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateUI();
        Picasso.with(this).load(selectedMovie.getFinalPosterUrl()).placeholder(R.drawable.ic_launcher_background).into(detailBinding.ivPoster);
        setTitle(selectedMovie.getTitle());
        Picasso.with(this).load(selectedMovie.getFinalBackdropUrl()).into(detailBinding.ivBackground);
    ...
    private void insertMovieToFavourites() {
        ...
        Log.e(LOG_TAG, "This is the movie backdrop url:" + selectedMovie.getBackdropUrl());
        movieValues.put(MovieEntry.COLUMN_MOVIE_POSTER_URL, selectedMovie.getPosterUrl());
        Log.e(LOG_TAG, "This is the movie final poster url:" + selectedMovie.getPosterUrl());
        movieValues.put(MovieEntry.COLUMN_MOVIE_VOTE_AVERAGE, selectedMovie.getPosterUrl());
